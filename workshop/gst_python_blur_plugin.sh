...
# gst-launch-1.0 filesrc location=$FILENAME ! decodebin ! videoconvert ! gaussian_blur kernel=21 sigmaX = 5.0 sigmaY=5.0 ! videoconvert ! gtksink sync=False

gst-launch-1.0 videomixer name=mixer ! videoconvert ! gtksink sync=False \
